--LIBRARY START
	...
	local library = {design = getgenv().design == "kali" and "kali" or "skylight", tabs = {}, draggable = true, flags = {}, title = "skylight", open = false, mousestate = inputService.MouseIconEnabled, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = "skylight", fileext = ".cfg"}
			...
			function column:AddSection(title)
				...
				function section:AddToggle(option)
					...
					function option:AddColor(subOption)
						...
						subOption.sub = true
						subOption.subpos = (self.subcount - 1) * 24
	...
	library.SettingsTab = library:AddTab("Settings", 999)
	...
	library.SettingsMenu:AddColor({text = "Accent Color", flag = "Menu Accent Color", color = Color3.fromRGB(155, 115, 255), callback = function(Color)
