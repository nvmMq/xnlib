...
local library = {
    ...
    signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/nvmMq/xnlib/main/signal.lua'))();
    open = false;
    opening = false;
    hasInit = false;
    cheatname = startupArgs.cheatname or 'quartz.pink';
...
function library:CreateSettingsTab(menu)
    ...
    mainSection:AddBind({text = 'Menu Keybind', flag = 'togglebind', nomouse = true, noindicator = true, bind = Enum.KeyCode.Delete, callback = function()
    ...
    mainSection:AddButton({text = 'Unload Script', confirm = true, callback = function()
        library:Unload();
    end})
