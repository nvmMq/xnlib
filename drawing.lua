...
local function RotateVector(Vector,Radians)
    ...
    return V2New(Vector.X * C - Vector.Y * S, Vector.X * S + Vector.Y * C)
end
...
RunService.Heartbeat:Connect(function(Delta)
    for Object, ESP in pairs(DrawingLibrary.ObjectESP) do
        ...
        ESP.Target.InTheRange = CheckDistance(GetFlag(ESP.Flags, ESP.GlobalFlag, "/DistanceCheck"), GetFlag(ESP.Flags,ESP.GlobalFlag,"/Distance"),ESP.Target.Distance)
        ...
        if ESP.Target.Character and ESP.Target.RootPart then
            ...
            if ESP.Target.OnScreen then
                ...
                if ESP.Target.InTheRange then
                    ...
                    ESP.Target.Color = GetFlag(ESP.Flags,ESP.Flag,"/TeamColor") and ESP.Target.TeamColor or (ESP.Target.InEnemyTeam and GetFlag(ESP.Flags,ESP.Flag,"/Enemy")[6] or GetFlag(ESP.Flags,ESP.Flag,"/Ally")[6])
                    ...
                    if ESP.RESP.Tracer.Visible or ESP.RESP.HeadDot.Visible then
                        ...
                        if Head then
                            ...
                            if ESP.RESP.Tracer.Visible then
                                ...
                                Mode = (Mode[1] == "From Mouse" and UserInputService:GetMouseLocation()) or (Mode[1] == "From Bottom" and V2New(Camera.ViewportSize.X / 2,Camera.ViewportSize.Y))
                    ...
                    if ESP.RESP.Box.Visible then
                        ...
                        if ESP.RESP.Box.TextLists.Top.Title.Visible or ESP.RESP.Box.TextLists.Left.Health.Visible or ESP.RESP.Box.TextLists.Bottom.Distance.Visible or ESP.RESP.Box.TextLists.Right.Weapon.Visible then
                            ...
                            if ESP.RESP.Box.TextLists.Top.Title.Visible then
                                ...
                                ESP.RESP.Box.TextLists.Top.Title.Text = ESP.Mode == "Player" and Target.Name or (ESP.Target.InEnemyTeam and "Enemy NPC" or "Ally NPC")
                            end
